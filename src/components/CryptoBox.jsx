          ...
          <div className="field-group output-group">
            <div className="field-header">
              ...
              <div className="output-field-actions">
                <button className="btn-icon" onClick={handleToggleView} title={isExpanded ? 'Riduci' : 'Espandi'}>
                  {isExpanded ? (
          ...
          {isFullscreen && (
            <div className="fullscreen-overlay">
              <div className="fullscreen-header">
                <span className="fullscreen-title">Risultato</span>
                <div className="fullscreen-actions">
                  ...
                  <button className="btn-icon btn-close-fullscreen" onClick={() => setIsFullscreen(false)} title="Chiudi">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
